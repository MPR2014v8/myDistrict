...
<body>
    ...
    <div class="container my-3">
        ...
        <h2 class="text-center">แบบฟอร์มบันทึกข้อมูลสมาชิก</h2>
        <form action="../manage/insertData_member.php" method="post">
            ...
            <button class="btn btn-success my-2" name="insert_user" type="submit">เพิ่มข้อมูลสมาชิก</button>
