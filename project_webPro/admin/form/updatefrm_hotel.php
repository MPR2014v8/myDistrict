...
<body>
    ...
    <div class="container my-3">
        ...
        <h2 class="text-center">แบบฟอร์มแก้ไขข้อมูลที่พัก</h2>
        <form action="../manage/updateData_place.php" method="post">
            ...
            <label for="name">ประเภทสถานที่</label>
                <?php
                $sql = "SELECT id, name FROM categories WHERE id = 5;";
                $result = mysqli_query($conn, $sql);
                ?>
            ...
            <button class="btn btn-success my-2" name="update_hotel" type="submit">แก้ไขข้อมูลสถานที่</button>
