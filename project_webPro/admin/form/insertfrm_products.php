...
<body>
    ...
    <div class="container my-3">
        ...
        <h2 class="text-center">แบบฟอร์มบันทึกข้อมูลสินค้า</h2>
        <form action="../manage/insertData_products.php" method="post">
            ...
            <div class="col-sm-3">
            <label for="place">สถานที่ขายสินค้า</label>
                <?php
            ...
            <button class="btn btn-success my-2" name="insert_pro" type="submit">เพิ่มข้อมูลสินค้า</button>
