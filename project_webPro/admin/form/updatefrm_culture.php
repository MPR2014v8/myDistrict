...
$sql = "SELECT c.id as 'id', c.name as 'name', detail, v.name as 'village', v.id as 'id_vill' FROM `culture` as c INNER JOIN village as v ON c.id_vill = v.id WHERE c.id = '$id'";
...
<head>
    ...
    <title>แก้ไขข้อมูลประเพณี</title>
...
<body>
    ...
    <div class="container my-3">
        ...
        <h2 class="text-center">แบบฟอร์มแก้ไขข้อมูลประเพณี</h2>
        <form action="../manage/updateData_culture.php" method="post">
            ...
            <button class="btn btn-success my-2" name="update_cul" type="submit">แก้ไขข้อมูลสมาชิก</button>
