...
$sql = "SELECT pro.id as 'id', pro.name as 'name', pro.detail as 'detail', p.name as 'place' FROM `products` as pro INNER JOIN place as p ON pro.id_pln = p.id;";
...
<head>
    ...
    <title>ดูข้อมูลตารางสินค้า</title>
