...
$str = $_POST["search_products"];

$sql = "SELECT pro.id as 'id', pro.name as 'name', pro.detail as 'detail', id_pln, p.name as 'place' FROM `products` as pro INNER JOIN place as p ON pro.id_pln = p.id WHERE pro.name LIKE '%" . $str . "%' OR p.name LIKE '%" . $str . "%';";
