...
$sql = "
    SELECT pro.id as 'pro_id', p.id as 'p_id', p.name as 'p_name', lat, lng, v.name as 'v_name', sd.name as 'sd_name', pro.name as 'pro_name', pro.detail as 'pro_detail', link
    FROM picofproducts as picp 
    INNER JOIN products as pro ON picp.id_pro = pro.id
    ...
    <section id="detail" class="py-5">
        ...
        <div class="container">
            <div class="row my-4 justify-content-center">
                <!-- title -->
                <div class="title">
                    <h2><?php echo $objResult1['pro_name']; ?></h2>
                </div>
                <!-- images -->
                ...
                <div class="detail mt-4">
                    <p>
                        <?php echo $objResult1['pro_detail']; ?>
                        <br><br>
                        <?php echo $objResult1['p_name']; ?> <br>
